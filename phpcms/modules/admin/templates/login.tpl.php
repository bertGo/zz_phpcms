...
<style type="text/css">
	...
	.login_box{background:url(<?php echo IMG_PATH?>join4.png) no-repeat;background-size: 100% 100%; width:602px; height:416px; overflow:hidden; position:absolute; left:50%; top:50%; margin-left:-301px; margin-top:-208px;}
